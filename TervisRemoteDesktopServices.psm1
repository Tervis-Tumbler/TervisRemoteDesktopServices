...
function New-BackOfficeRemoteDesktopShortcut {
    ...
    process {
        $RemoteDesktopRDPContent = New-BackOfficeRDPFileContent -UserName $UserName
        $PublicDesktopPathRemote = $PublicDesktopPath | ConvertTo-RemotePath -ComputerName $ComputerName
        $RemoteDesktopRDPContent | Out-File -FilePath "$PublicDesktopPathRemote/Remote Desktop.rdp" -NoNewline -Encoding ascii
    }
}
